...
divBtnCSV.setAttribute('style',"display: flex; height: 24px") 
...
const setButtons = setInterval( () => {
    ...
    if(!document.getElementById(BREAK)){
        ...
        if(containerDadosGrupo){   
            ...
            const [linkSeeAll] =  document.querySelectorAll('.i5tg98hk.f9ovudaz.przvwfww.ddw6s8x9.shdiholb.phqmzxqs.pm5hny62.ajgl1lbb.thr4l2wc.cc8mgx9x.eta5aym1.d9802myq.e4xiuwjv.q1n4p668.ln8gz9je.p357zi0d.gndfcl4n.os03hap6');
